    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card-auth tw-bg-[#f6f7fb] dark:tw-bg-[#171717] tw-rounded-xl p-4">
                <div class="card-header py-3">{{ __('Confirm Password') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.confirm') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12">
                                <input id="password" type="password" class="input tw-h-full tw-w-full !tw-border-gray-600 tw-p-2 tw-outline-none @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
